...
// LwOneWeekCalendar
#define COCOAPODS_POD_AVAILABLE_LwOneWeekCalendar
#define COCOAPODS_VERSION_MAJOR_LwOneWeekCalendar 0
#define COCOAPODS_VERSION_MINOR_LwOneWeekCalendar 1
#define COCOAPODS_VERSION_PATCH_LwOneWeekCalendar 0
